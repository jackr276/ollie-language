...
struct symtab_function_record_t{
	...
	//What is the set of all errors that this function may or may not raise?
	dynamic_array_t raises_errors;
	//The line number
...
struct symtab_macro_record_t{
	...
	/**
	 * Since parameters are required to be one token only, we can
	 * store them inside of a simple token array here.
	 */
	ollie_token_array_t parameters;
