...
void not_equals_constant_nodes(generic_ast_node_t* constant_node1, generic_ast_node_t* constant_node2){
	...
	switch(constant_node1->constant_type){
		...
		case CHAR_CONST:
			...
			switch(constant_node2->constant_type){
				case DOUBLE_CONST:
					constant_node1->constant_value.char_value = constant_node1->constant_value.signed_long_value != constant_node2->constant_value.double_value;
					break;
				case LONG_CONST_FORCE_U:
					constant_node1->constant_value.char_value = constant_node1->constant_value.signed_long_value != (int64_t)(constant_node2->constant_value.unsigned_long_value);
					break;
				case LONG_CONST:
					 constant_node1->constant_value.char_value = constant_node1->constant_value.signed_long_value != constant_node2->constant_value.signed_long_value;
					break;
				case INT_CONST_FORCE_U:
					 constant_node1->constant_value.char_value = constant_node1->constant_value.signed_long_value != (int32_t)(constant_node2->constant_value.unsigned_int_value);
					break;
				case FLOAT_CONST:
					constant_node1->constant_value.char_value = constant_node1->constant_value.signed_long_value != constant_node2->constant_value.float_value;
					break;
				case INT_CONST:
					constant_node1->constant_value.signed_long_value = constant_node1->constant_value.signed_long_value != constant_node2->constant_value.signed_int_value;
					break;
