...
static const ollie_token_t tok_array[] = {IF, ELSE, DO, WHILE, FOR, FN, ERROR, RETURN, JUMP, REQUIRE, 
...
static const char* keyword_array[] = {"if", "else", "do", "while", "for", "fn", "error", "ret", "jump",
						 "require", "u8", "i8", "u16",
