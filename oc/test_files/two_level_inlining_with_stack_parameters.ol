...
pub inline fn involved_function_int(x:i32, y:i32, z:i32, aa:i32, bb:i32, cc:i32, dd:i32) -> i32 {
	let result:f32 = @involved_function_float(x, y, z, aa, bb, cc, dd, x, y);

	ret result + x + y + z + aa + bb + cc + dd;
}


pub fn main() -> i32 {
	//should return 65 + (int)100.0 = 165
	OUNIT: [exit_status = 165]
	ret @involved_function_int(32, 3, 4, 5, 6, 7, 8);
}
