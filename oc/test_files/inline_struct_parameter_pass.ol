/**
* Author: Jack Robbins
* Test our ability to pass a struct by copy when we have an inlined function
*/
...
pub inline fn param_passed_struct(parameter_struct:struct my_struct, x:i32, y:i32) -> i32{
	/**
