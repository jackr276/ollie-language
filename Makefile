...
interference_graph_tester: parser.o option_parser.o lexer.o build_system.o dependency_graph.o symtab.o heapstack.o type_system.o ast.o cfg.o variable_mapping.o static_analyzer.o lexstack.o instruction.o heap_queue.o dynamic_array.o dynamic_integer_array.o lightstack.o optimizer.o instruction_selector.o jump_table.o stack_data_area.o interference_graph.o interference_graph_test.o dynamic_string.o nesting_stack.o min_priority_queue.o dynamic_set.o ollie_token_array.o preprocessor.o local_constant.o parameter_result_array.o value_numbering_table.o graph_analyzer.o
	$(CC) -o $(OUT_LOCAL)/interference_graph_test $(OUT_LOCAL)/interference_graph_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/option_parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/dependency_graph.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/variable_mapping.o $(OUT_LOCAL)/static_analyzer.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/optimizer.o $(OUT_LOCAL)/instruction_selector.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/interference_graph.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/preprocessor.o $(OUT_LOCAL)/local_constant.o $(OUT_LOCAL)/parameter_result_array.o $(OUT_LOCAL)/value_numbering_table.o $(OUT_LOCAL)/graph_analyzer.o
...
instruction_selector_test: parser.o option_parser.o lexer.o build_system.o dependency_graph.o symtab.o heapstack.o type_system.o ast.o cfg.o variable_mapping.o static_analyzer.o lexstack.o instruction.o heap_queue.o preprocessor.o dynamic_array.o dynamic_integer_array.o lightstack.o jump_table.o optimizer.o stack_data_area.o dynamic_string.o nesting_stack.o instruction_selector.o instruction_selector_test.o min_priority_queue.o dynamic_set.o ollie_token_array.o local_constant.o parameter_result_array.o value_numbering_table.o data_dependency_graph.o graph_analyzer.o
	$(CC) -o $(OUT_LOCAL)/instruction_selector_test $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/option_parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/dependency_graph.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/variable_mapping.o $(OUT_LOCAL)/static_analyzer.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preprocessor.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/optimizer.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/instruction_selector.o $(OUT_LOCAL)/instruction_selector_test.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/local_constant.o $(OUT_LOCAL)/parameter_result_array.o $(OUT_LOCAL)/value_numbering_table.o $(OUT_LOCAL)/data_dependency_graph.o $(OUT_LOCAL)/graph_analyzer.o

instruction_selector_testd: parserd.o option_parserd.o lexerd.o build_systemd.o dependency_graphd.o symtabd.o heapstackd.o type_systemd.o astd.o cfgd.o variable_mappingd.o static_analyzerd.o lexstackd.o instructiond.o heap_queued.o preprocessord.o dynamic_arrayd.o dynamic_integer_arrayd.o lightstackd.o jump_tabled.o optimizerd.o stack_data_aread.o dynamic_stringd.o nesting_stackd.o instruction_selectord.o instruction_selector_testd.o min_priority_queued.o dynamic_setd.o ollie_token_arrayd.o local_constantd.o parameter_result_arrayd.o value_numbering_tabled.o data_dependency_graphd.o graph_analyzerd.o
	$(CC) -o $(OUT_LOCAL)/instruction_selector_testd $(OUT_LOCAL)/parserd.o $(OUT_LOCAL)/option_parserd.o $(OUT_LOCAL)/lexerd.o $(OUT_LOCAL)/build_systemd.o $(OUT_LOCAL)/dependency_graphd.o $(OUT_LOCAL)/heapstackd.o $(OUT_LOCAL)/lexstackd.o $(OUT_LOCAL)/symtabd.o $(OUT_LOCAL)/type_systemd.o $(OUT_LOCAL)/astd.o $(OUT_LOCAL)/cfgd.o $(OUT_LOCAL)/variable_mappingd.o $(OUT_LOCAL)/static_analyzerd.o $(OUT_LOCAL)/instructiond.o $(OUT_LOCAL)/heap_queued.o $(OUT_LOCAL)/dynamic_arrayd.o $(OUT_LOCAL)/dynamic_integer_arrayd.o $(OUT_LOCAL)/lightstackd.o $(OUT_LOCAL)/optimizerd.o $(OUT_LOCAL)/jump_tabled.o $(OUT_LOCAL)/stack_data_aread.o $(OUT_LOCAL)/dynamic_stringd.o $(OUT_LOCAL)/nesting_stackd.o $(OUT_LOCAL)/instruction_selectord.o $(OUT_LOCAL)/instruction_selector_testd.o $(OUT_LOCAL)/min_priority_queued.o $(OUT_LOCAL)/dynamic_setd.o $(OUT_LOCAL)/ollie_token_arrayd.o $(OUT_LOCAL)/preprocessord.o $(OUT_LOCAL)/local_constantd.o $(OUT_LOCAL)/parameter_result_arrayd.o $(OUT_LOCAL)/value_numbering_tabled.o $(OUT_LOCAL)/data_dependency_graphd.o $(OUT_LOCAL)/graph_analyzerd.o

oc: compiler.o parser.o option_parser.o lexer.o build_system.o dependency_graph.o symtab.o heapstack.o type_system.o ast.o cfg.o variable_mapping.o static_analyzer.o lexstack.o instruction.o heap_queue.o preprocessor.o dynamic_array.o dynamic_integer_array.o lightstack.o optimizer.o instruction_selector.o jump_table.o stack_data_area.o register_allocator.o instruction_scheduler.o interference_graph.o assembler.o dynamic_string.o nesting_stack.o postprocessor.o data_dependency_graph.o max_priority_queue.o min_priority_queue.o dynamic_set.o ollie_token_array.o local_constant.o parameter_result_array.o value_numbering_table.o graph_analyzer.o
	$(CC) -o $(OUT_LOCAL)/oc $(OUT_LOCAL)/compiler.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/option_parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/dependency_graph.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/variable_mapping.o $(OUT_LOCAL)/static_analyzer.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preprocessor.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/optimizer.o $(OUT_LOCAL)/instruction_selector.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/register_allocator.o $(OUT_LOCAL)/instruction_scheduler.o $(OUT_LOCAL)/interference_graph.o $(OUT_LOCAL)/assembler.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/postprocessor.o $(OUT_LOCAL)/data_dependency_graph.o $(OUT_LOCAL)/max_priority_queue.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/local_constant.o $(OUT_LOCAL)/parameter_result_array.o $(OUT_LOCAL)/value_numbering_table.o $(OUT_LOCAL)/graph_analyzer.o

oc_debug: compilerd.o parserd.o option_parserd.o lexerd.o build_systemd.o dependency_graphd.o symtabd.o heapstackd.o type_systemd.o astd.o cfgd.o variable_mappingd.o static_analyzerd.o lexstackd.o instructiond.o heap_queued.o preprocessord.o dynamic_arrayd.o dynamic_integer_arrayd.o lightstackd.o optimizerd.o instruction_selectord.o jump_tabled.o stack_data_aread.o register_allocatord.o instruction_schedulerd.o interference_graphd.o assemblerd.o dynamic_stringd.o nesting_stackd.o postprocessord.o data_dependency_graphd.o max_priority_queued.o min_priority_queued.o dynamic_setd.o ollie_token_arrayd.o local_constantd.o parameter_result_arrayd.o value_numbering_tabled.o graph_analyzerd.o
	$(CC) -o $(OUT_LOCAL)/ocd $(OUT_LOCAL)/compilerd.o $(OUT_LOCAL)/parserd.o $(OUT_LOCAL)/option_parserd.o $(OUT_LOCAL)/lexerd.o $(OUT_LOCAL)/build_systemd.o $(OUT_LOCAL)/dependency_graphd.o $(OUT_LOCAL)/heapstackd.o $(OUT_LOCAL)/symtabd.o $(OUT_LOCAL)/lexstackd.o $(OUT_LOCAL)/type_systemd.o $(OUT_LOCAL)/astd.o $(OUT_LOCAL)/cfgd.o $(OUT_LOCAL)/variable_mappingd.o $(OUT_LOCAL)/static_analyzerd.o $(OUT_LOCAL)/instructiond.o $(OUT_LOCAL)/heap_queued.o $(OUT_LOCAL)/preprocessord.o $(OUT_LOCAL)/dynamic_arrayd.o $(OUT_LOCAL)/dynamic_integer_arrayd.o $(OUT_LOCAL)/lightstackd.o $(OUT_LOCAL)/optimizerd.o $(OUT_LOCAL)/instruction_selectord.o $(OUT_LOCAL)/jump_tabled.o $(OUT_LOCAL)/stack_data_aread.o $(OUT_LOCAL)/register_allocatord.o $(OUT_LOCAL)/instruction_schedulerd.o $(OUT_LOCAL)/interference_graphd.o $(OUT_LOCAL)/assemblerd.o $(OUT_LOCAL)/dynamic_stringd.o $(OUT_LOCAL)/nesting_stackd.o $(OUT_LOCAL)/postprocessord.o $(OUT_LOCAL)/data_dependency_graphd.o $(OUT_LOCAL)/max_priority_queued.o $(OUT_LOCAL)/min_priority_queued.o $(OUT_LOCAL)/dynamic_setd.o $(OUT_LOCAL)/ollie_token_arrayd.o $(OUT_LOCAL)/local_constantd.o $(OUT_LOCAL)/parameter_result_arrayd.o $(OUT_LOCAL)/value_numbering_tabled.o $(OUT_LOCAL)/graph_analyzerd.o
...
interference_graph_tester-CI: parser-CI.o option_parser-CI.o lexer-CI.o build_system-CI.o dependency_graph-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o variable_mapping-CI.o static_analyzer-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o lightstack-CI.o optimizer-CI.o instruction_selector-CI.o jump_table-CI.o stack_data_area-CI.o interference_graph-CI.o interference_graph_test-CI.o dynamic_string-CI.o nesting_stack-CI.o min_priority_queue-CI.o dynamic_set-CI.o ollie_token_array-CI.o local_constant-CI.o parameter_result_array-CI.o value_numbering_table-CI.o graph_analyzer-CI.o
	$(CC) -o $(OUT_CI)/interference_graph_test $(OUT_CI)/interference_graph_test.o $(OUT_CI)/parser.o $(OUT_CI)/option_parser.o $(OUT_CI)/lexer.o $(OUT_CI)/build_system.o $(OUT_CI)/dependency_graph.o $(OUT_CI)/heapstack.o $(OUT_CI)/lexstack.o $(OUT_CI)/symtab.o $(OUT_CI)/type_system.o $(OUT_CI)/ast.o $(OUT_CI)/cfg.o $(OUT_CI)/variable_mapping.o $(OUT_CI)/static_analyzer.o $(OUT_CI)/instruction.o $(OUT_CI)/heap_queue.o $(OUT_CI)/dynamic_array.o $(OUT_CI)/dynamic_integer_array.o $(OUT_CI)/lightstack.o $(OUT_CI)/optimizer.o $(OUT_CI)/instruction_selector.o $(OUT_CI)/jump_table.o $(OUT_CI)/stack_data_area.o $(OUT_CI)/interference_graph.o $(OUT_CI)/dynamic_string.o $(OUT_CI)/nesting_stack.o $(OUT_CI)/min_priority_queue.o $(OUT_CI)/dynamic_set.o $(OUT_CI)/ollie_token_array.o $(OUT_CI)/local_constant.o $(OUT_CI)/parameter_result_array.o $(OUT_CI)/value_numbering_table.o $(OUT_CI)/graph_analyzer.o
...
instruction_selector_test-CI: parser-CI.o option_parser-CI.o lexer-CI.o build_system-CI.o dependency_graph-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o variable_mapping-CI.o static_analyzer-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o preprocessor-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o lightstack-CI.o jump_table-CI.o optimizer-CI.o stack_data_area-CI.o dynamic_string-CI.o nesting_stack-CI.o instruction_selector-CI.o instruction_selector_test-CI.o min_priority_queue-CI.o dynamic_set-CI.o ollie_token_array-CI.o local_constant-CI.o parameter_result_array-CI.o value_numbering_table-CI.o data_dependency_graph-CI.o graph_analyzer-CI.o
...
oc_debug-CI: compiler-CId.o parser-CId.o option_parser-CId.o lexer-CId.o build_system-CId.o dependency_graph-CId.o symtab-CId.o heapstack-CId.o type_system-CId.o ast-CId.o cfg-CId.o variable_mapping-CId.o static_analyzer-CId.o lexstack-CId.o instruction-CId.o heap_queue-CId.o preprocessor-CId.o dynamic_array-CId.o dynamic_integer_array-CId.o lightstack-CId.o optimizer-CId.o instruction_selector-CId.o jump_table-CId.o stack_data_area-CId.o register_allocator-CId.o instruction_scheduler-CId.o interference_graph-CId.o assembler-CId.o dynamic_string-CId.o nesting_stack-CId.o postprocessor-CId.o data_dependency_graph-CId.o max_priority_queue-CId.o min_priority_queue-CId.o dynamic_set-CId.o ollie_token_array-CId.o local_constant-CId.o parameter_result_array-CId.o value_numbering_table-CId.o graph_analyzer-CId.o
	$(CC) -o $(OUT_CI)/ocd $(OUT_CI)/compilerd.o $(OUT_CI)/parserd.o $(OUT_CI)/option_parserd.o $(OUT_CI)/lexerd.o $(OUT_CI)/build_systemd.o $(OUT_CI)/dependency_graphd.o $(OUT_CI)/heapstackd.o $(OUT_CI)/lexstackd.o $(OUT_CI)/symtabd.o $(OUT_CI)/type_systemd.o $(OUT_CI)/astd.o $(OUT_CI)/cfgd.o $(OUT_CI)/variable_mappingd.o $(OUT_CI)/static_analyzerd.o $(OUT_CI)/instructiond.o $(OUT_CI)/heap_queued.o $(OUT_CI)/preprocessord.o $(OUT_CI)/dynamic_arrayd.o $(OUT_CI)/dynamic_integer_arrayd.o $(OUT_CI)/lightstackd.o $(OUT_CI)/optimizerd.o $(OUT_CI)/instruction_selectord.o $(OUT_CI)/jump_tabled.o $(OUT_CI)/stack_data_aread.o $(OUT_CI)/register_allocatord.o $(OUT_CI)/instruction_schedulerd.o $(OUT_CI)/interference_graphd.o $(OUT_CI)/assembler-CId.o $(OUT_CI)/dynamic_stringd.o $(OUT_CI)/nesting_stackd.o $(OUT_CI)/postprocessord.o $(OUT_CI)/data_dependency_graphd.o $(OUT_CI)/max_priority_queued.o $(OUT_CI)/min_priority_queued.o $(OUT_CI)/dynamic_setd.o $(OUT_CI)/ollie_token_arrayd.o $(OUT_CI)/local_constantd.o $(OUT_CI)/parameter_result_arrayd.o $(OUT_CI)/value_numbering_tabled.o $(OUT_CI)/graph_analyzerd.o
