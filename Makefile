...
symtab_test-CI: symtab-CI.o symtab_test-CI.o lexer-CI.o type_system-CI.o lexstack-CI.o lightstack-CI.o stack_data_area-CI.o instruction-CI.o dynamic_array-CI.o heap_queue-CI.o heapstack-CI.o dynamic_string-CI.o nesting_stack-CI.o call_graph-CI.o jump_table-CI.o
