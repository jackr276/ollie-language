...
memory_checker.o: $(TEST_SUITE_PATH)/memory_test.c
	$(CC) $(CFLAGS) -o $(OUT_LOCAL)/memory_checker.o $(TEST_SUITE_PATH)/memory_test.c
...
interference_graph_tester: parser.o lexer.o symtab.o heapstack.o type_system.o ast.o cfg.o call_graph.o lexstack.o instruction.o heap_queue.o dynamic_array.o lightstack.o optimizer.o instruction_selector.o jump_table.o stack_data_area.o interference_graph.o interference_graph_test.o dynamic_string.o nesting_stack.o
	$(CC) -o $(OUT_LOCAL)/interference_graph_test $(OUT_LOCAL)/interference_graph_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/call_graph.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/optimizer.o $(OUT_LOCAL)/instruction_selector.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/interference_graph.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o

front_end_test: front_end_test.o parser.o lexer.o symtab.o heapstack.o type_system.o ast.o cfg.o call_graph.o lexstack.o instruction.o heap_queue.o preproc.o dependency_tree.o dynamic_array.o lightstack.o jump_table.o stack_data_area.o dynamic_string.o nesting_stack.o
	$(CC) -o $(OUT_LOCAL)/front_end_test $(OUT_LOCAL)/front_end_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/call_graph.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preproc.o $(OUT_LOCAL)/dependency_tree.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o

front_end_testd: front_end_testd.o parser.o lexer.o symtab.o heapstack.o type_system.o ast.o cfg.o call_graph.o lexstack.o instructiond.o heap_queue.o preproc.o dependency_treed.o dynamic_array.o lightstack.o jump_tabled.o stack_data_aread.o dynamic_stringd.o nesting_stackd.o
	$(CC) -o $(OUT_LOCAL)/front_end_testd $(OUT_LOCAL)/front_end_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/call_graph.o $(OUT_LOCAL)/instructiond.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preproc.o $(OUT_LOCAL)/dependency_treed.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/jump_tabled.o $(OUT_LOCAL)/stack_data_aread.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stackd.o

middle_end_test: middle_end_test.o parser.o lexer.o symtab.o heapstack.o type_system.o ast.o cfg.o call_graph.o lexstack.o instruction.o heap_queue.o preproc.o dependency_tree.o dynamic_array.o lightstack.o jump_table.o optimizer.o stack_data_area.o dynamic_string.o nesting_stack.o
	$(CC) -o $(OUT_LOCAL)/middle_end_test $(OUT_LOCAL)/middle_end_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/call_graph.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preproc.o $(OUT_LOCAL)/dependency_tree.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/optimizer.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o
...
memory_checker: memory_checker.o
	$(CC) -o $(OUT_LOCAL)/memory_checker $(OUT_LOCAL)/memory_checker.o
...
memory_check: oc_debug memory_checker
	$(OUT_LOCAL)/memory_checker $(OUT_LOCAL)/oc_debug $(TEST_FILE_DIR)
...
interference_graph_tester-CI: parser-CI.o lexer-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o call_graph-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o dynamic_array-CI.o lightstack-CI.o optimizer-CI.o instruction_selector-CI.o jump_table-CI.o stack_data_area-CI.o interference_graph-CI.o interference_graph_test-CI.o dynamic_string-CI.o nesting_stack-CI.o
...
front_end_test-CI: front_end_test-CI.o parser-CI.o lexer-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o call_graph-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o preproc-CI.o dependency_tree-CI.o dynamic_array-CI.o lightstack-CI.o jump_table-CI.o stack_data_area-CI.o dynamic_string-CI.o nesting_stack-CI.o
...
middle_end_test-CI: middle_end_test-CI.o parser-CI.o lexer-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o call_graph-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o preproc-CI.o dependency_tree-CI.o dynamic_array-CI.o lightstack-CI.o jump_table-CI.o optimizer-CI.o stack_data_area-CI.o dynamic_string-CI.o nesting_stack-CI.o
