...
lexer_test: lexer.o build_system.o lexer_test.o lexstack.o dynamic_string.o ollie_token_array.o
	$(CC) -o $(OUT_LOCAL)/lexer_test $(OUT_LOCAL)/lexer_test.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/ollie_token_array.o

lexer_testd: lexerd.o build_systemd.o lexer_testd.o lexstackd.o dynamic_stringd.o ollie_token_arrayd.o
	$(CC) -o $(OUT_LOCAL)/lexer_testd $(OUT_LOCAL)/lexer_testd.o $(OUT_LOCAL)/lexerd.o $(OUT_LOCAL)/build_systemd.o $(OUT_LOCAL)/lexstackd.o $(OUT_LOCAL)/dynamic_stringd.o $(OUT_LOCAL)/ollie_token_arrayd.o
...
parser_test: parser.o lexer.o build_system.o parser_test.o symtab.o lexstack.o heapstack.o type_system.o ast.o heap_queue.o lightstack.o dynamic_array.o dynamic_integer_array.o stack_data_area.o instruction.o dynamic_string.o nesting_stack.o min_priority_queue.o dynamic_set.o ollie_token_array.o preprocessor.o
	$(CC) -o $(OUT_LOCAL)/parser_test $(OUT_LOCAL)/parser_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/preprocessor.o

parser_test_debug: parserd.o lexerd.o build_systemd.o parser_testd.o symtabd.o lexstack.o heapstackd.o type_systemd.o astd.o heap_queued.o lightstackd.o dynamic_arrayd.o dynamic_integer_arrayd.o stack_data_aread.o instructiond.o dynamic_stringd.o nesting_stackd.o min_priority_queued.o dynamic_setd.o ollie_token_arrayd.o preprocessord.o
	$(CC) -g -o $(OUT_LOCAL)/parser_test_debug $(OUT_LOCAL)/parser_testd.o $(OUT_LOCAL)/parserd.o $(OUT_LOCAL)/lexstackd.o $(OUT_LOCAL)/lexerd.o $(OUT_LOCAL)/build_systemd.o $(OUT_LOCAL)/heapstackd.o $(OUT_LOCAL)/symtabd.o $(OUT_LOCAL)/type_systemd.o $(OUT_LOCAL)/astd.o $(OUT_LOCAL)/heap_queued.o $(OUT_LOCAL)/lightstackd.o $(OUT_LOCAL)/dynamic_arrayd.o $(OUT_LOCAL)/dynamic_integer_arrayd.o $(OUT_LOCAL)/stack_data_aread.o $(OUT_LOCAL)/instructiond.o $(OUT_LOCAL)/dynamic_stringd.o $(OUT_LOCAL)/nesting_stackd.o $(OUT_LOCAL)/min_priority_queued.o $(OUT_LOCAL)/dynamic_setd.o $(OUT_LOCAL)/ollie_token_arrayd.o $(OUT_LOCAL)/preprocessord.o

symtab_test: symtab.o symtab_test.o lexer.o build_system.o type_system.o lexstack.o lightstack.o stack_data_area.o dynamic_array.o dynamic_integer_array.o heap_queue.o heapstack.o jump_table.o dynamic_string.o nesting_stack.o min_priority_queue.o dynamic_set.o ollie_token_array.o
	$(CC) -o $(OUT_LOCAL)/symtab_test $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/symtab_test.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o

symtab_testd: symtabd.o symtab_testd.o lexerd.o build_systemd.o type_systemd.o lexstackd.o lightstackd.o stack_data_aread.o instructiond.o dynamic_arrayd.o dynamic_integer_arrayd.o dynamic_stringd.o nesting_stackd.o min_priority_queued.o dynamic_setd.o ollie_token_arrayd.o
	$(CC) -o $(OUT_LOCAL)/symtab_testd $(OUT_LOCAL)/lexerd.o $(OUT_LOCAL)/build_systemd.o $(OUT_LOCAL)/symtab_testd.o $(OUT_LOCAL)/symtabd.o $(OUT_LOCAL)/type_systemd.o $(OUT_LOCAL)/lexstackd.o $(OUT_LOCAL)/lightstackd.o $(OUT_LOCAL)/stack_data_aread.o $(OUT_LOCAL)/instructiond.o $(OUT_LOCAL)/dynamic_arrayd.o $(OUT_LOCAL)/dynamic_integer_arrayd.o $(OUT_LOCAL)/dynamic_stringd.o $(OUT_LOCAL)/nesting_stackd.o $(OUT_LOCAL)/min_priority_queued.o $(OUT_LOCAL)/dynamic_setd.o $(OUT_LOCAL)/ollie_token_arrayd.o

stack_data_area_test: stack_data_area_test.o type_system.o lexstack.o lightstack.o symtab.o lexer.o build_system.o instruction.o stack_data_area.o dynamic_array.o dynamic_integer_array.o ast.o cfg.o parser.o heap_queue.o heapstack.o jump_table.o dynamic_string.o nesting_stack.o min_priority_queue.o dynamic_set.o ollie_token_array.o preprocessor.o local_constant.o parameter_result_array.o graph_analyzer.o
	$(CC) -o $(OUT_LOCAL)/stack_data_area_test $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/stack_data_area_test.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/preprocessor.o $(OUT_LOCAL)/local_constant.o $(OUT_LOCAL)/parameter_result_array.o $(OUT_LOCAL)/graph_analyzer.o
	
stack_data_area_testd: stack_data_area_testd.o type_systemd.o lexstackd.o lightstackd.o symtabd.o lexerd.o build_systemd.o instructiond.o stack_data_aread.o dynamic_arrayd.o dynamic_integer_arrayd.o astd.o cfgd.o parserd.o heap_queued.o heapstackd.o jump_tabled.o dynamic_stringd.o nesting_stackd.o min_priority_queue.o dynamic_setd.o ollie_token_arrayd.o preprocessord.o local_constantd.o parameter_result_arrayd.o graph_analyzerd.o
	$(CC) -o $(OUT_LOCAL)/stack_data_area_testd $(OUT_LOCAL)/lexerd.o $(OUT_LOCAL)/build_systemd.o $(OUT_LOCAL)/stack_data_area_testd.o $(OUT_LOCAL)/symtabd.o $(OUT_LOCAL)/type_systemd.o $(OUT_LOCAL)/lexstackd.o $(OUT_LOCAL)/lightstackd.o $(OUT_LOCAL)/instructiond.o $(OUT_LOCAL)/stack_data_aread.o $(OUT_LOCAL)/dynamic_arrayd.o $(OUT_LOCAL)/dynamic_integer_arrayd.o $(OUT_LOCAL)/astd.o $(OUT_LOCAL)/cfgd.o $(OUT_LOCAL)/parserd.o $(OUT_LOCAL)/heap_queued.o $(OUT_LOCAL)/heapstackd.o $(OUT_LOCAL)/jump_tabled.o $(OUT_LOCAL)/dynamic_stringd.o $(OUT_LOCAL)/nesting_stackd.o $(OUT_LOCAL)/min_priority_queued.o $(OUT_LOCAL)/dynamic_setd.o $(OUT_LOCAL)/ollie_token_arrayd.o $(OUT_LOCAL)/preprocessord.o $(OUT_LOCAL)/local_constantd.o $(OUT_LOCAL)/parameter_result_arrayd.o $(OUT_LOCAL)/graph_analyzerd.o

interference_graph_tester: parser.o lexer.o build_system.o symtab.o heapstack.o type_system.o ast.o cfg.o lexstack.o instruction.o heap_queue.o dynamic_array.o dynamic_integer_array.o lightstack.o optimizer.o instruction_selector.o jump_table.o stack_data_area.o interference_graph.o interference_graph_test.o dynamic_string.o nesting_stack.o min_priority_queue.o dynamic_set.o ollie_token_array.o preprocessor.o local_constant.o parameter_result_array.o value_numbering_table.o graph_analyzer.o
	$(CC) -o $(OUT_LOCAL)/interference_graph_test $(OUT_LOCAL)/interference_graph_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/optimizer.o $(OUT_LOCAL)/instruction_selector.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/interference_graph.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/preprocessor.o $(OUT_LOCAL)/local_constant.o $(OUT_LOCAL)/parameter_result_array.o $(OUT_LOCAL)/value_numbering_table.o $(OUT_LOCAL)/graph_analyzer.o

front_end_test: front_end_test.o parser.o lexer.o build_system.o symtab.o heapstack.o type_system.o ast.o cfg.o lexstack.o instruction.o heap_queue.o preprocessor.o dynamic_array.o dynamic_integer_array.o lightstack.o jump_table.o stack_data_area.o dynamic_string.o nesting_stack.o min_priority_queue.o dynamic_set.o ollie_token_array.o local_constant.o parameter_result_array.o graph_analyzer.o
	$(CC) -o $(OUT_LOCAL)/front_end_test $(OUT_LOCAL)/front_end_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o  $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preprocessor.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/local_constant.o $(OUT_LOCAL)/parameter_result_array.o $(OUT_LOCAL)/graph_analyzer.o

front_end_testd: front_end_testd.o parser.o lexer.o build_system.o symtab.o heapstack.o type_system.o ast.o cfg.o lexstack.o instructiond.o heap_queue.o dynamic_array.o dynamic_integer_array.o lightstack.o jump_tabled.o stack_data_aread.o dynamic_stringd.o nesting_stackd.o min_priority_queued.o dynamic_setd.o ollie_token_arrayd.o preprocessord.o local_constantd.o parameter_result_arrayd.o graph_analyzerd.o
	$(CC) -o $(OUT_LOCAL)/front_end_testd $(OUT_LOCAL)/front_end_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o  $(OUT_LOCAL)/instructiond.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preprocessord.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/jump_tabled.o $(OUT_LOCAL)/stack_data_aread.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stackd.o $(OUT_LOCAL)/min_priority_queued.o $(OUT_LOCAL)/dynamic_setd.o $(OUT_LOCAL)/ollie_token_arrayd.o $(OUT_LOCAL)/local_constantd.o $(OUT_LOCAL)/parameter_result_arrayd.o $(OUT_LOCAL)/graph_analyzerd.o

middle_end_test: middle_end_test.o parser.o lexer.o build_system.o symtab.o heapstack.o type_system.o ast.o cfg.o lexstack.o instruction.o heap_queue.o preprocessor.o dynamic_array.o dynamic_integer_array.o lightstack.o jump_table.o optimizer.o stack_data_area.o dynamic_string.o nesting_stack.o min_priority_queue.o dynamic_set.o ollie_token_array.o preprocessor.o local_constant.o parameter_result_array.o value_numbering_table.o data_dependency_graph.o graph_analyzer.o
	$(CC) -o $(OUT_LOCAL)/middle_end_test $(OUT_LOCAL)/middle_end_test.o $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preprocessor.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/optimizer.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/local_constant.o $(OUT_LOCAL)/parameter_result_array.o $(OUT_LOCAL)/value_numbering_table.o $(OUT_LOCAL)/data_dependency_graph.o $(OUT_LOCAL)/graph_analyzer.o

middle_end_testd: middle_end_testd.o parserd.o lexerd.o build_systemd.o symtabd.o heapstackd.o type_systemd.o astd.o cfgd.o lexstackd.o instructiond.o heap_queued.o preprocessord.o dynamic_arrayd.o dynamic_integer_arrayd.o lightstackd.o jump_tabled.o optimizerd.o stack_data_aread.o dynamic_stringd.o nesting_stackd.o min_priority_queued.o dynamic_setd.o ollie_token_arrayd.o preprocessord.o local_constantd.o parameter_result_arrayd.o value_numbering_tabled.o data_dependency_graphd.o graph_analyzerd.o
	$(CC) -o $(OUT_LOCAL)/middle_end_testd $(OUT_LOCAL)/middle_end_testd.o $(OUT_LOCAL)/parserd.o $(OUT_LOCAL)/lexerd.o $(OUT_LOCAL)/build_systemd.o $(OUT_LOCAL)/heapstackd.o $(OUT_LOCAL)/lexstackd.o $(OUT_LOCAL)/symtabd.o $(OUT_LOCAL)/type_systemd.o $(OUT_LOCAL)/astd.o $(OUT_LOCAL)/cfgd.o $(OUT_LOCAL)/instructiond.o $(OUT_LOCAL)/heap_queued.o $(OUT_LOCAL)/preprocessord.o $(OUT_LOCAL)/dynamic_arrayd.o $(OUT_LOCAL)/dynamic_integer_arrayd.o $(OUT_LOCAL)/lightstackd.o $(OUT_LOCAL)/optimizerd.o $(OUT_LOCAL)/jump_tabled.o $(OUT_LOCAL)/stack_data_aread.o $(OUT_LOCAL)/dynamic_stringd.o $(OUT_LOCAL)/nesting_stackd.o $(OUT_LOCAL)/min_priority_queued.o $(OUT_LOCAL)/dynamic_setd.o $(OUT_LOCAL)/ollie_token_arrayd.o $(OUT_LOCAL)/local_constantd.o $(OUT_LOCAL)/parameter_result_arrayd.o $(OUT_LOCAL)/value_numbering_tabled.o $(OUT_LOCAL)/data_dependency_graphd.o $(OUT_LOCAL)/graph_analyzerd.o

instruction_selector_test: parser.o lexer.o build_system.o symtab.o heapstack.o type_system.o ast.o cfg.o lexstack.o instruction.o heap_queue.o preprocessor.o dynamic_array.o dynamic_integer_array.o lightstack.o jump_table.o optimizer.o stack_data_area.o dynamic_string.o nesting_stack.o instruction_selector.o instruction_selector_test.o min_priority_queue.o dynamic_set.o ollie_token_array.o local_constant.o parameter_result_array.o value_numbering_table.o data_dependency_graph.o graph_analyzer.o
	$(CC) -o $(OUT_LOCAL)/instruction_selector_test $(OUT_LOCAL)/parser.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/heapstack.o $(OUT_LOCAL)/lexstack.o $(OUT_LOCAL)/symtab.o $(OUT_LOCAL)/type_system.o $(OUT_LOCAL)/ast.o $(OUT_LOCAL)/cfg.o $(OUT_LOCAL)/instruction.o $(OUT_LOCAL)/heap_queue.o $(OUT_LOCAL)/preprocessor.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lightstack.o $(OUT_LOCAL)/optimizer.o $(OUT_LOCAL)/jump_table.o $(OUT_LOCAL)/stack_data_area.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/nesting_stack.o $(OUT_LOCAL)/instruction_selector.o $(OUT_LOCAL)/instruction_selector_test.o $(OUT_LOCAL)/min_priority_queue.o $(OUT_LOCAL)/dynamic_set.o $(OUT_LOCAL)/ollie_token_array.o $(OUT_LOCAL)/local_constant.o $(OUT_LOCAL)/parameter_result_array.o $(OUT_LOCAL)/value_numbering_table.o $(OUT_LOCAL)/data_dependency_graph.o $(OUT_LOCAL)/graph_analyzer.o
...
ollie_run_validator: ollie_run_validator.o dynamic_array.o dynamic_integer_array.o lexer.o build_system.o dynamic_string.o ollie_token_array.o
	$(CC) -pthread -o $(OUT_LOCAL)/ollie_run_validator $(OUT_LOCAL)/ollie_run_validator.o $(OUT_LOCAL)/dynamic_array.o $(OUT_LOCAL)/dynamic_integer_array.o $(OUT_LOCAL)/lexer.o $(OUT_LOCAL)/build_system.o $(OUT_LOCAL)/dynamic_string.o $(OUT_LOCAL)/ollie_token_array.o
...
lexer_test-CI: lexer-CI.o build_system-CI.o lexer_test-CI.o lexstack-CI.o dynamic_string-CI.o ollie_token_array-CI.o
	$(CC) -o $(OUT_CI)/lexer_test $(OUT_CI)/lexer_test.o $(OUT_CI)/lexer.o $(OUT_CI)/build_system.o $(OUT_CI)/lexstack.o $(OUT_CI)/dynamic_string.o $(OUT_CI)/ollie_token_array.o
...
preprocessor_test-CI: preprocessor_test-CI.o preprocessor-CI.o symtab-CI.o lexer-CI.o build_system-CI.o type_system-CI.o lexstack-CI.o lightstack-CI.o stack_data_area-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o heap_queue-CI.o heapstack-CI.o jump_table-CI.o dynamic_string-CI.o nesting_stack-CI.o min_priority_queue-CI.o dynamic_set-CI.o ollie_token_array-CI.o
	$(CC) -o $(OUT_CI)/preprocessor_test $(OUT_CI)/lexer.o $(OUT_CI)/build_system.o $(OUT_CI)/preprocessor_test.o $(OUT_CI)/preprocessor.o $(OUT_CI)/symtab.o $(OUT_CI)/type_system.o $(OUT_CI)/lexstack.o $(OUT_CI)/lightstack.o $(OUT_CI)/stack_data_area.o $(OUT_CI)/dynamic_array.o $(OUT_CI)/dynamic_integer_array.o $(OUT_CI)/heap_queue.o $(OUT_CI)/heapstack.o $(OUT_CI)/jump_table.o $(OUT_CI)/dynamic_string.o $(OUT_CI)/nesting_stack.o $(OUT_CI)/min_priority_queue.o $(OUT_CI)/dynamic_set.o $(OUT_CI)/ollie_token_array.o
...
interference_graph_tester-CI: parser-CI.o lexer-CI.o build_system-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o lightstack-CI.o optimizer-CI.o instruction_selector-CI.o jump_table-CI.o stack_data_area-CI.o interference_graph-CI.o interference_graph_test-CI.o dynamic_string-CI.o nesting_stack-CI.o min_priority_queue-CI.o dynamic_set-CI.o ollie_token_array-CI.o local_constant-CI.o parameter_result_array-CI.o value_numbering_table-CI.o graph_analyzer-CI.o
	$(CC) -o $(OUT_CI)/interference_graph_test $(OUT_CI)/interference_graph_test.o $(OUT_CI)/parser.o $(OUT_CI)/lexer.o $(OUT_CI)/build_system.o $(OUT_CI)/heapstack.o $(OUT_CI)/lexstack.o $(OUT_CI)/symtab.o $(OUT_CI)/type_system.o $(OUT_CI)/ast.o $(OUT_CI)/cfg.o $(OUT_CI)/instruction.o $(OUT_CI)/heap_queue.o $(OUT_CI)/dynamic_array.o $(OUT_CI)/dynamic_integer_array.o $(OUT_CI)/lightstack.o $(OUT_CI)/optimizer.o $(OUT_CI)/instruction_selector.o $(OUT_CI)/jump_table.o $(OUT_CI)/stack_data_area.o $(OUT_CI)/interference_graph.o $(OUT_CI)/dynamic_string.o $(OUT_CI)/nesting_stack.o $(OUT_CI)/min_priority_queue.o $(OUT_CI)/dynamic_set.o $(OUT_CI)/ollie_token_array.o $(OUT_CI)/local_constant.o $(OUT_CI)/parameter_result_array.o $(OUT_CI)/value_numbering_table.o $(OUT_CI)/graph_analyzer.o

front_end_test-CI: front_end_test-CI.o parser-CI.o lexer-CI.o build_system-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o preprocessor-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o lightstack-CI.o jump_table-CI.o stack_data_area-CI.o dynamic_string-CI.o nesting_stack-CI.o min_priority_queue-CI.o dynamic_set-CI.o ollie_token_array-CI.o local_constant-CI.o parameter_result_array-CI.o graph_analyzer-CI.o
...
middle_end_test-CI: middle_end_test-CI.o parser-CI.o lexer-CI.o build_system-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o preprocessor-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o lightstack-CI.o jump_table-CI.o optimizer-CI.o stack_data_area-CI.o dynamic_string-CI.o nesting_stack-CI.o min_priority_queue-CI.o dynamic_set-CI.o ollie_token_array-CI.o local_constant-CI.o parameter_result_array-CI.o value_numbering_table-CI.o data_dependency_graph-CI.o graph_analyzer-CI.o
...
instruction_selector_test-CI: parser-CI.o lexer-CI.o build_system-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o preprocessor-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o lightstack-CI.o jump_table-CI.o optimizer-CI.o stack_data_area-CI.o dynamic_string-CI.o nesting_stack-CI.o instruction_selector-CI.o instruction_selector_test-CI.o min_priority_queue-CI.o dynamic_set-CI.o ollie_token_array-CI.o local_constant-CI.o parameter_result_array-CI.o value_numbering_table-CI.o data_dependency_graph-CI.o graph_analyzer-CI.o
...
ollie_run_validator-CI: ollie_run_validator-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o lexer-CI.o build_system-CI.o dynamic_string-CI.o ollie_token_array-CI.o
		$(CC) -pthread -o $(OUT_CI)/ollie_run_validator $(OUT_CI)/ollie_run_validator.o $(OUT_CI)/dynamic_array.o $(OUT_CI)/dynamic_integer_array.o $(OUT_CI)/lexer.o $(OUT_CI)/build_system.o $(OUT_CI)/dynamic_string.o $(OUT_CI)/ollie_token_array.o

oc-CI: compiler-CI.o parser-CI.o lexer-CI.o build_system-CI.o symtab-CI.o heapstack-CI.o type_system-CI.o ast-CI.o cfg-CI.o lexstack-CI.o instruction-CI.o heap_queue-CI.o preprocessor-CI.o dynamic_array-CI.o dynamic_integer_array-CI.o lightstack-CI.o optimizer-CI.o instruction_selector-CI.o jump_table-CI.o stack_data_area-CI.o register_allocator-CI.o instruction_scheduler-CI.o interference_graph-CI.o assembler-CI.o dynamic_string-CI.o nesting_stack-CI.o postprocessor-CI.o data_dependency_graph-CI.o max_priority_queue-CI.o min_priority_queue-CI.o dynamic_set-CI.o ollie_token_array-CI.o local_constant-CI.o parameter_result_array-CI.o value_numbering_table-CI.o graph_analyzer-CI.o
